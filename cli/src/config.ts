...
export class Config implements CliConfig {
  ...
  android = {
    ...
    assets: {
      ...
      pluginsFolderName: 'jigra-cordova-android-plugins',
      templateDir: '',
      pluginsDir: '',
    }
  };
  ...
  ios = {
    ...
    assets: {
      ...
      pluginsFolderName: 'jigra-cordova-ios-plugins',
      templateDir: '',
      pluginsDir: '',
    }
  };
  ...
  app = {
    ...
    extConfigName: 'jigra.config.json',
    extConfigFilePath: '',
    extConfig: ExtConfig,
  ...
  loadExternalConfig() {
    ...
    try {
      ...
      try {
        // we've got an jigra.json file, let's parse it
      ...
      // it's ok if there's no jigra.json file
    }
  }
  ...
  platformNotCreatedError(platformName: string) {
    ...
    logFatal(`${chalk.bold(platformName)}" platform has not been created. Use "npx jig add ${platformName}" to add the platform project.`);
  }
}
