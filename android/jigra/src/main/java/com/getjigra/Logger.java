...
public class Logger {
  public static final String LOG_TAG_CORE = "Jigra";
  public static JigConfig config;
  ...
  public static void init(JigConfig config) {
    Logger.getInstance().loadConfig(config);
  }

  private void loadConfig(JigConfig config) {
      this.config = config;
  }
