...
public class Splash {
  ...
  private static void buildViews(Context c, JigConfig config) {
    if (splashImage == null) {
   ...
   * @param a
   */
  public static void showOnLaunch(final BridgeActivity a, JigConfig config) {
