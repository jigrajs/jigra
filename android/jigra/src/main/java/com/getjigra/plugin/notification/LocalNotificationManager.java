package com.getjigra.plugin.notification;
...
public class LocalNotificationManager {
  ...
  public LocalNotificationManager(NotificationStorage notificationStorage, Activity activity, Context context, JigConfig config) {
