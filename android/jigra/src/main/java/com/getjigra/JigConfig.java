...
/**
 * Management interface for accessing values in jigra.config.json
 */
public class JigConfig {
  ...
  private void loadConfig(AssetManager assetManager) {
    ...
    try {
      reader = new BufferedReader(new InputStreamReader(assetManager.open("jigra.config.json")));
