  ...
  public void postMessage(String jsonStr) {
    try {
      ...
      if (isCordovaPlugin) {
        ...
        Logger.verbose(Logger.tags("Plugin"), "To native (Jigra plugin): callbackId: " + callbackId + ", pluginId: " + pluginId + ", methodName: " + methodName);
  ...
  public void sendResponseMessage(PluginCall call, PluginResult successResult, PluginResult errorResult) {
    try {
      ...
      if (isValidCallbackId) {
        final String runScript = "window.Jigra.fromNative(" + data.toString() + ")";
