...
export interface AppPlugin extends Plugin {
   ...
   *
   * Family handles this itself so you shouldn't need to call this if using Family
   */
  exitApp(): never;
  /**
...
export interface CameraOptions {
   ...
   *
   * Learn more about PWA Elements: https://jigrajs.web.app/docs/pwa-elements
   */
  webUseInput?: boolean;
...
export interface LocalNotification {
   ...
   * If set, it overrides default icon from jigra.config.json
   */
  smallIcon?: string;
  /**
...
export interface ActionSheetOption {
  ...
  /**
   * Icon for web (famicon naming convention)
   */
  icon?: string;
}
