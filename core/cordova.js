    ...
    define("cordova", function (require, exports, module) {
        ...
        var cordova = {
            ...
            fireDocumentEvent: function (type, data, bNoDetach) {
                var evt = Jigra.createEvent(type, data);
    ...
    define("cordova/exec", function (require, exports, module) {
        ...
        function proxyChanged() {
            ...
            return (execProxy !== cexec && // proxy objects are different
                jigraExec !== cexec      // proxy object is not the current jigraExec
            );
        }
        ...
        jigraExec.nativeFetchMessages = function () {
        ...
        jigraExec.nativeCallback = function (callbackId, status, message, keepCallback, debug) {
        ...
        jigraExec.nativeEvalAndFetch = function (func) {
            try {
                func();
            } catch (e) {
                console.log(e);
        ...
        function cordovaExec() {
            ...
            return (cexec_valid && execProxy !== cexec) ? cexec : jigraExec;
        }
        function execProxy() {
