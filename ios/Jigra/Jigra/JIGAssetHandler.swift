...
class JIGAssetHandler: NSObject, WKURLSchemeHandler {
  ...
  func webView(_ webView: WKWebView, start urlSchemeTask: WKURLSchemeTask) {
      ...
      if stringToLoad.starts(with: JIGBridge.JIG_FILE_START) {
        startPath = stringToLoad.replacingOccurrences(of: JIGBridge.JIG_FILE_START, with: "")
