...
@objc(JIGAccessibilityPlugin)
public class JIGAccessibilityPlugin : JIGPlugin {
  ...
  @objc func onScreenReaderStateChanged(notification: NSNotification) {
    notifyListeners(JIGAccessibilityPlugin.SCREEN_READER_STATE_CHANGE_EVENT, data: [
      "value": UIAccessibility.isVoiceOverRunning
    ])
  }
  
  @objc func isScreenReaderEnabled(_ call: JIGPluginCall) {
