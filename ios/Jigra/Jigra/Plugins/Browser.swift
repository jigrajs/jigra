...
@objc(JIGBrowserPlugin)
public class JIGBrowserPlugin : JIGPlugin, SFSafariViewControllerDelegate {
  var vc: SFSafariViewController?
  
  @objc func open(_ call: JIGPluginCall) {
  ...
  @objc func close(_ call: JIGPluginCall) {
    if vc == nil {
      call.success()
    }
    DispatchQueue.main.async {
  ...
  @objc func prefetch(_ call: JIGPluginCall) {
    call.unimplemented()
  }
