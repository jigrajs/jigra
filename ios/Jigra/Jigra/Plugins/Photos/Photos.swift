...
@objc(JIGPhotosPlugin)
public class JIGPhotosPlugin : JIGPlugin {
  ...
  @objc func getAlbums(_ call: JIGPluginCall) {
  ...
  @objc func getPhotos(_ call: JIGPluginCall) {
    checkAuthorization(allowed: {
  ...
  @objc func createAlbum(_ call: JIGPluginCall) {
  ...
  @objc func savePhoto(_ call: JIGPluginCall) {
  ...
  func fetchAlbumsToJs(_ call: JIGPluginCall) {
    var albums = [JSObject]()
  ...
  func fetchResultAssetsToJs(_ call: JIGPluginCall) {
    var assets: [JSObject] = []
    
    let albumId = call.getString("albumIdentifier")

    let quantity = call.getInt("quantity", JIGPhotosPlugin.DEFAULT_QUANTITY)!
    ...
    let types = call.getString("types") ?? JIGPhotosPlugin.DEFAULT_TYPES
    let thumbnailWidth = call.getInt("thumbnailWidth", JIGPhotosPlugin.DEFAULT_THUMBNAIL_WIDTH)!
    let thumbnailHeight = call.getInt("thumbnailHeight", JIGPhotosPlugin.DEFAULT_THUMBNAIL_HEIGHT)!
