...
@interface JIGKeyboard () <UIScrollViewDelegate>
...
- (void)setKeyboardHeight:(int)height delay:(NSTimeInterval)delay
{
  ...
  __weak JIGKeyboard* weakSelf = self;
...
- (void)setAccessoryBarVisible:(JIGPluginCall *)call
{
...
- (void)show:(JIGPluginCall *)call
{
  [call unimplemented];
}

- (void)setStyle:(JIGPluginCall *)call
{
...
- (void)setScroll:(JIGPluginCall *)call {
