 ...
 */
@objc(JIGStatusBarPlugin)
public class JIGStatusBarPlugin: JIGPlugin {

  public override func load() {
    NotificationCenter.default.addObserver(forName: JIGBridge.statusBarTappedNotification.name, object: .none, queue: .none) { _ in
