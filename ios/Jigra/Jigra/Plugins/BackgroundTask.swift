...
@objc(JIGBackgroundTaskPlugin)
public class JIGBackgroundTaskPlugin : JIGPlugin {
  ...
  @objc func beforeExit(_ call: JIGPluginCall) {
  ...
  @objc func finish(_ call: JIGPluginCall) {
  ...
  @objc func fetch(_ call: JIGPluginCall) {
   
  }
  
  @objc func onAppTerminate() {
    JIGLog.print("APP TERMINATING IN BACKGROUND TASK")
  }
}
