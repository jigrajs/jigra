...
@objc(JIGFilesystemPlugin)
public class JIGFilesystemPlugin : JIGPlugin {
   ...
   */
  func handleError(_ call: JIGPluginCall, _ message: String, _ error: Error? = nil) {
   ...
   */
  @objc func readFile(_ call: JIGPluginCall) {
   ...
   */
  @objc func writeFile(_ call: JIGPluginCall) {
    let encoding = call.getString("encoding")
   ...
   * Append to a file.
   */
  @objc func appendFile(_ call: JIGPluginCall) {
    let encoding = call.getString("encoding")
    // TODO: Allow them to switch encoding
    guard let file = call.get("path", String.self) else {
      handleError(call, "path must be provided and must be a string.")
   ...
   * Delete a file.
   */
  @objc func deleteFile(_ call: JIGPluginCall) {
   ...
   */
  @objc func mkdir(_ call: JIGPluginCall) {
   ...
   * Remove a directory.
   */
  @objc func rmdir(_ call: JIGPluginCall) {
    guard let path = call.get("path", String.self) else {
      handleError(call, "path must be provided and must be a string.")
      return
    }
   ...
   */
  @objc func readdir(_ call: JIGPluginCall) {
    guard let path = call.get("path", String.self) else {
      handleError(call, "path must be provided and must be a string.")
      return
    }
  ...
  @objc func stat(_ call: JIGPluginCall) {
    guard let path = call.get("path", String.self) else {
      handleError(call, "path must be provided and must be a string.")
      return
    }
  ...
  @objc func getUri(_ call: JIGPluginCall) {
    guard let path = call.get("path", String.self) else {
      handleError(call, "path must be provided and must be a string.")
      return
    }
   ...
   */
  @objc func rename(_ call: JIGPluginCall) {
   ...
   */
  @objc func copy(_ call: JIGPluginCall) {
   ...
   */
  private func _copy(call: JIGPluginCall, doRename: Bool) {
