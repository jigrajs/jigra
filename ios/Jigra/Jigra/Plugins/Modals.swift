 ...
 */
@objc(JIGModalsPlugin)
public class JIGModalsPlugin : JIGPlugin {
  @objc public func alert(_ call: JIGPluginCall) {
  ...
  @objc public func confirm(_ call: JIGPluginCall) {
    guard let title = call.options["title"] as? String else {
      call.error("title must be provided")
      return
    }
  ...
  @objc public func prompt (_ call: JIGPluginCall) {
    guard let title = call.options["title"] as? String else {
      call.error("title must be provided")
      return
    }
  ...
  func buildActionSheet(_ call: JIGPluginCall, title: String, message: String, options: JSArray) -> UIAlertController {
