...
@objc(JIGDevicePlugin)
public class JIGDevicePlugin: JIGPlugin {
  ...
  @objc func getAdvertisingIdentifier(_ call: JIGPluginCall) {
  }
  
  @objc func getMemoryUsage(_ call: JIGPluginCall) {
  }
