...
{
  [self.commandDelegate evalJsHelper2:@"window.Jigra.triggerEvent('pause', 'document');"];
}

- (void)onAppWillEnterForeground:(NSNotification*)notification
{
  [self.commandDelegate evalJsHelper2:@"window.Jigra.triggerEvent('resume', 'document');"];
}
